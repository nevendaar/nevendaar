...
ActiveRecord::Schema.define(version: 20170917090525) do
  ...
  create_table "news_notes", force: :cascade do |t|
    t.string "title"
    t.text "brief"
    t.text "text"
    t.bigint "user_id"
    ...
    t.index ["user_id"], name: "index_news_notes_on_user_id"
  end
  ...
  add_foreign_key "news_notes", "users"
